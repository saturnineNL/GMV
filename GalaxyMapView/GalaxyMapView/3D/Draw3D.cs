...
namespace GalaxyMapView._3D
{
    public class Draw3D
    {
            ...
            Point3D rotation=default(Point3D),Point3D translation=default(Point3D),Point3D scaling=default(Point3D))
        {
            ...
            if (doTranslation) inputPoint = CalculateTranslation(inputPoint, translation);
        ...
        public Point3D CalculateTranslation(Point3D input,Point3D displacement)
        {
            ...
            pts[0] = new Point3(displacement.X, displacement.Y, displacement.Z, 0);

            Matrix3 m = Matrix3.Translate3(input.X, input.Y, input.Z);
